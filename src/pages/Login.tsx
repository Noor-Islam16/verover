          ...
          <View style={{ marginTop: 25 }}>
            ...
            <View style={{ marginTop:20 }}>
              ...
              <View style={styles.inputContainer}>
                ...
                >
                 <Image source={secureEntry ? require('../assets/eye.png') : require('../assets/eyeoff.png')}
            ...
            <View style={styles.socialContainer}>
              ...
              <Image 
                source={require('../assets/google1.png')} style={{width: 25, height:25}}
              />
              </TouchableOpacity>
              <TouchableOpacity style={[styles.socialButton, { marginHorizontal: 20 }]}>
              <Image 
                source={require('../assets/fb.png')} style={{width: 10, height:25}}
              />
              </TouchableOpacity>
              <TouchableOpacity style={styles.socialButton}>
              <Image 
                source={require('../assets/apple.png')} style={{width: 25, height:25}}
              />
              </TouchableOpacity>
